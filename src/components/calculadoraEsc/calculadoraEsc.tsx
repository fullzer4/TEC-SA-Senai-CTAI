      ...
      <div className="calculadora">
        ...
        <div className="calculadora-boxes">
          ...
          <div className="calculadora-box c-3d">
            ...
            <h3 className="text-calc"> 3 / 2 pV = U <p/> Calculos Possiveis:<p/>  3 / 2 pV = x<p/>  3 / 2 px = U<p/>  3 / 2 xV = U<p/> Qa = Calor na fonte de aquecimento <p/> Qr = Calor na fonte de resfriamento <p/> T = Trabalho <p/>Todas as medidas dessa calculadora estão em jaule(J) <p/></h3>
            <button className="button-calc" onClick={verClickCalc5}>Abrir</button>
          </div>

          <div className="calculadora-box c-3d">
            <h2 className="title-calc">Energia Interna Temperatura</h2>
            <h3 className="text-calc">3 / 2 nRT = U <p/> Calculos Possiveis:<p/> 3 / 2 nRT = x<p/> 3 / 2 nRx = U<p/> 3 / 2 nxT = U<p/>  3 / 2 xRT = U<p/>Qa = Calor na fonte de aquecimento <p/> Qr = Calor na fonte de resfriamento <p/> T = Trabalho <p/>Todas as medidas dessa calculadora estão em jaule(J) <p/></h3>
            <button className="button-calc" onClick={verClickCalc5}>Abrir</button>
          </div>

          <div className="calculadora-box c-3d">
            <h2 className="title-calc">Variação de Energia Interna</h2>
            <h3 className="text-calc">3 / 2 nRΔT = ΔU <p/> Calculos Possiveis:<p/> 3 / 2 nRΔT = x<p/> 3 / 2 nRx = ΔU<p/> 3 / 2 nxΔT = ΔU<p/> 3 / 2 xRΔT = ΔU<p/>Qa = Calor na fonte de aquecimento <p/> Qr = Calor na fonte de resfriamento <p/> T = Trabalho <p/>Todas as medidas dessa calculadora estão em jaule(J) <p/></h3>
            <button className="button-calc" onClick={verClickCalc5}>Abrir</button>
          </div>

          <div className="calculadora-box c-3d">
            <h2 className="title-calc">Trabalho de um Gás Sob Pressão Constante</h2>
            <h3 className="text-calc">pΔV = T <p/> Calculos Possiveis:<p/> pΔV = x<p/> px = T<p/> xΔV = T<p/> Qa = Calor na fonte de aquecimento <p/> Qr = Calor na fonte de resfriamento <p/> T = Trabalho <p/>Todas as medidas dessa calculadora estão em jaule(J) <p/></h3>
            <button className="button-calc" onClick={verClickCalc5}>Abrir</button>
          </div>
      
          <div className="calculadora-box c-3d">
            <h2 className="title-calc">Trabalho de um Gás Sob Temperatura Constante</h2>
            <h3 className="text-calc">nRTln(V2 / V1) = T <p/> Calculos Possiveis:<p/> nRTln(V2 / V1) = x<p/> nRTn(V2 / x) = T<p/> nRTln(x / V1) = T<p/> nRTx(V2 / V1) = T<p/>nxln(V2 / V1) = T<p/>xRTln(V2 / V1) = T<p/>Qa = Calor na fonte de aquecimento <p/> Qr = Calor na fonte de resfriamento <p/> T = Trabalho <p/>Todas as medidas dessa calculadora estão em jaule(J) <p/></h3>
            <button className="button-calc" onClick={verClickCalc5}>Abrir</button>
          </div>
