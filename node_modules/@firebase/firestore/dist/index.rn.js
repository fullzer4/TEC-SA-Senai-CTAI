 ...
 */ class Et {
    ...
    /** Returns an offset that sorts before all regular offsets. */    static min() {
        return new Et(at.min(), _t.empty(), -1);
    }
    /** Returns an offset that sorts after all regular offsets. */    static max() {
        return new Et(at.max(), _t.empty(), -1);
    }
}
 ...
 */ async function Pt(t) {
    if (t.code !== Q.FAILED_PRECONDITION || t.message !== Rt) throw t;
 ...
 */ class vt {
    ...
    next(t, e) {
        return this.callbackAttached && U(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new vt(((n, s) => {
            this.nextCallback = e => {
...
class Vt {
    constructor(t, e) {
        ...
        this.T = new W, this.transaction.oncomplete = () => {
            ...
            e.error ? this.T.reject(new Ct(t, e.error)) : this.T.resolve();
        }, this.transaction.onerror = e => {
            const n = Mt(e.target.error);
            this.T.reject(new Ct(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
 ...
 */ class St {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === St.v(a()) && $("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return F("SimpleDb", "Removing database:", t), kt(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static V() {
        ...
        // Check the UA string to find out the browser.
                const t = a(), e = St.v(t), n = 0 < e && e < 10, s = St.D(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async k(t) {
        return this.db || (F("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new j(Q.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s.name ? n(new j(Q.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s)) : n(new Ct(t, s));
            }, s.onupgradeneeded = t => {
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ct extends j {
    constructor(t, e) {
    ...
    Z(t) {
        F("IndexBackiller", `Scheduled in ${t}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill" /* IndexBackfill */ , t, (async () => {
            ...
            try {
                ...
                xt(t) ? F("IndexBackiller", "Ignoring IndexedDB error during index backfill: ", t) : await Pt(t);
            }
            await this.Z(1);
        }));
    }
...
class Kt {
    ...
    insert(t, e) {
        return new Kt(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, Qt.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new Kt(this.comparator, this.root.remove(t, this.comparator).copy(null, null, Qt.BLACK, null, null));
    }
    ...
    getIterator() {
        return new Gt(this.root, null, this.comparator, !1);
    }
    getIteratorFrom(t) {
        return new Gt(this.root, t, this.comparator, !1);
    }
    getReverseIterator() {
        return new Gt(this.root, null, this.comparator, !0);
    }
    getReverseIteratorFrom(t) {
        return new Gt(this.root, t, this.comparator, !0);
    }
}
...
class jt {
    ...
    copy(t) {
        const e = new jt(this.comparator);
        return e.data = t, e;
    }
}
 ...
 */ class Ht {
     ...
     */    unionWith(t) {
        let e = new jt(dt.comparator);
        for (const t of this.fields) e = e.add(t);
        for (const n of t) e = e.add(n);
        return new Ht(e.toArray());
    }
    /**
...
function de(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? se(t) ? 4 /* ServerTimestampValue */ : ve(t) ? 9007199254740991 /* MaxValue */ : 10 /* ObjectValue */ : U();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function _e(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return ot(t.arrayValue.values || [], e.arrayValue.values || [], _e);
...
function me(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = rt(ee(t.latitude), ee(e.latitude));
            if (0 !== n) return n;
            return rt(ee(t.longitude), ee(e.longitude));
...
function ge(t, e) {
    ...
    const n = te(t), s = te(e), i = rt(n.seconds, s.seconds);
...
/** Creates a deep copy of `source`. */ function Pe(t) {
    ...
    if (t.mapValue) {
        ...
        return Ut(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Pe(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
...
/** Returns the lowest value for the given value type (inclusive). */ function Ve(t) {
    return "nullValue" in t ? fe : "booleanValue" in t ? {
        ...
        bytesValue: ""
    } : "referenceValue" in t ? Ie(ue.empty(), _t.empty()) : "geoPointValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
...
/** Returns the largest value for the given value type (exclusive). */ function Se(t) {
    return "nullValue" in t ? {
        ...
        bytesValue: ""
    } : "bytesValue" in t ? Ie(ue.empty(), _t.empty()) : "referenceValue" in t ? {
        geoPointValue: {
            latitude: -90,
            longitude: -180
        }
 ...
 */ class ke {
     ...
     */    static newInvalidDocument(t) {
        return new ke(t, 0 /* INVALID */ , at.min(), at.min(), xe.empty(), 0 /* SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, e, n) {
        return new ke(t, 1 /* FOUND_DOCUMENT */ , e, at.min(), n, 0 /* SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new ke(t, 2 /* NO_DOCUMENT */ , e, at.min(), xe.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new ke(t, 3 /* UNKNOWN_DOCUMENT */ , e, at.min(), xe.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
 ...
 * property.
 */ function Me(t, e = null, n = [], s = [], i = null, r = null, o = null) {
    return new Oe(t, e, n, s, i, r, o);
}
 ...
 */ function fn(t) {
    ...
    if (null === e.lt) {
        ...
        t.isKeyField() || e.lt.push(new tn(t)), e.lt.push(new tn(dt.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
            ...
            if (!t) {
                ...
                e.lt.push(new tn(dt.keyField(), t));
            }
        }
    }
    return e.lt;
 ...
 */ function dn(t) {
    const e = G(t);
    if (!e.ft) if ("F" /* First */ === e.limitType) e.ft = Me(e.path, e.collectionGroup, fn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.ft = Me(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.ft;
}
...
function $n(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof Dn && e instanceof Dn || t instanceof xn && e instanceof xn ? ot(t.elements, e.elements, _e) : t instanceof kn && e instanceof kn ? _e(t._t, e._t) : t instanceof Sn && e instanceof Sn;
 ...
 */ function Kn(t, e) {
        ...
        if (null === e) return t.isNoDocument() ? new Zn(t.key, Ln.none()) : new zn(t.key, t.data, Ln.none());
    {
        ...
        return new Hn(t.key, s, new Ht(i.toArray()), Ln.none());
    }
}
...
function Wn(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && ot(t, e, ((t, e) => $n(t, e)));
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const us = new Kt(_t.comparator);

function cs() {
    return us;
}

const as = new Kt(_t.comparator);
...
const ws = new Kt(_t.comparator);

const ms = new jt(_t.comparator);
 ...
 */ class Is {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, Ts.createSynthesizedTargetChangeForCurrentChange(t, e)), new Is(at.min(), n, ps(), cs(), gs());
    }
}
...
class Ps {
     ...
     */    zt(t) {
        ...
        if (s) {
            ...
            if (Le(t)) if (0 === n) {
                ...
                this.Kt(e, n, ke.newNoDocument(n, at.min()));
            } else q(1 === n); else {
                this.Jt(e) !== n && (
     ...
     */    Yt(t) {
        ...
        return this.$t = cs(), this.Bt = vs(), this.Lt = new jt(rt), s;
    }
    /**
    ...
    Zt(t) {
        let e = this.Bt.get(t);
        return e || (e = new jt(rt), this.Bt = this.Bt.insert(t, e)), e;
    }
    /**
...
function Us(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? lt.emptyPath() : Ks(e);
}
...
function Qs(t, e, n) {
    const s = Bs(t, e.name), i = Os(e.updateTime), r = new xe({
        mapValue: {
            fields: e.fields
        }
...
function js(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Bs(t, e.found.name), s = Os(e.found.updateTime), i = new xe({
            mapValue: {
        ...
        const n = Bs(t, e.missing), s = Os(e.readTime);
...
function Ws(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.dt ? (q(void 0 === e || "string" == typeof e), Xt.fromBase64String(e || "")) : (q(void 0 === e || e instanceof Uint8Array), 
            Xt.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, u = o && function(t) {
            const e = void 0 === t.code ? Q.UNKNOWN : rs(t.code);
 ...
 */ (o);
        ...
        const i = Bs(t, s.document.name), r = Os(s.document.updateTime), o = new xe({
            mapValue: {
        ...
        s.document;
        const i = Bs(t, s.document), r = s.readTime ? Os(s.readTime) : at.min(), o = ke.newNoDocument(i, r), u = s.removedTargetIds || [];
        n = new Es([], u, o.key, o);
...
function Hs(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Ln.updateTime(Os(t.updateTime)) : void 0 !== t.exists ? Ln.exists(t.exists) : Ln.none();
    }(e.currentDocument) : Ln.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) q("REQUEST_TIME" === e.setToServerValue), n = new Sn; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new Dn(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new xn(t);
        } else "increment" in e ? n = new kn(t, e.increment) : U();
    ...
    if (e.update) {
        ...
        if (e.updateMask) {
            const t = function(t) {
                ...
                return new Ht(e.map((t => dt.fromServerFormat(t))));
            }(e.updateMask);
...
function Js(t, e) {
    return t && t.length > 0 ? (q(void 0 !== e), t.map((t => function(t, e) {
        ...
        let n = t.updateTime ? Os(t.updateTime) : Os(e);
        ...
        n = Os(e)), new Bn(n, t.transformResults || []);
    }(t, e)))) : [];
}
...
function ei(t) {
    return t ? void 0 !== t.unaryFilter ? [ ui(t) ] : void 0 !== t.fieldFilter ? [ oi(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => ei(t))).reduce(((t, e) => t.concat(e))) : U() : [];
}
 ...
 */ class Bi {
    ...
    isEqual(t) {
        return this.batchId === t.batchId && ot(this.mutations, t.mutations, ((t, e) => Wn(t, e))) && ot(this.baseMutations, t.baseMutations, ((t, e) => Wn(t, e)));
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function Gi(t, e) {
    ...
    if (e.document) n = Qs(t.ne, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
        const t = _t.fromSegments(e.noDocument.path), s = zi(e.noDocument.readTime);
        n = ke.newNoDocument(t, s), e.hasCommittedMutations && n.setHasCommittedMutations();
    } else {
        if (!e.unknownDocument) return U();
        {
            const t = _t.fromSegments(e.unknownDocument.path), s = zi(e.unknownDocument.version);
...
function Hi(t, e) {
    ...
    const s = e.mutations.map((e => Hs(t.ne, e))), i = ct.fromMillis(e.localWriteTimeMs);
    return new Bi(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function Ji(t) {
    const e = zi(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? zi(t.lastLimboFreeSnapshotVersion) : at.min();
    let s;
    var i;
 ...
 */ class dr {
    constructor() {
        this.Me = new hr, this.Fe = new lr(this.Me), this.$e = new fr(this.Me);
    }
    seed(t) {
        this.Me.seed(t);
    }
 ...
 */ class pr {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new jt(lt.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new jt(lt.comparator)).toArray();
    }
}
        ...
        return vt.forEach(this.Ye(e), (e => this.Xe(t, e).next((t => {
            ...
            if (s) {
                ...
                return vt.forEach(i, ((i, r) => {
                    ...
                    var o;
                    F("IndexedDbIndexManager", `Using index ${o = i, `id=${o.indexId}|cg=${o.collectionGroup}|f=${o.fields.map((t => `${t.fieldPath}:${t.kind}`)).join(",")}`} to execute ${Fe(e)}`);
 ...
 */ (r, i), c = function(t, e) {
                        const n = new Map;
                        for (const s of gt(e)) for (const e of Ue(t, s.fieldPath)) switch (e.op) {
                          case "==" /* EQUAL */ :
                          case "in" /* IN */ :
 ...
 */ (r, i), h = function(t, e) {
    ...
    getIndexType(t, e) {
        ...
        return vt.forEach(this.Ye(e), (e => this.Xe(t, e).next((t => {
            t ? 0 /* NONE */ !== n && t.fields.length < function(t) {
                let e = new jt(dt.comparator), n = !1;
    ...
    /** Encodes a single value to the ascending index format. */    nn(t) {
        const e = new dr;
        return ur.ye.re(t, e.Be(0 /* ASCENDING */)), e.Oe();
    }
    /**
     ...
     */    an(t, e, n) {
        ...
        for (const t of n.arrayValue.values || []) for (const n of s) {
            const s = new dr;
            s.seed(n.Oe()), ur.ye.re(t, s.Be(e.kind)), i.push(s);
        }
        return i;
    }
    cn(t, e) {
    ...
    getFieldIndexes(t, e) {
        ...
        return (e ? n.K("collectionGroupIndex", IDBKeyRange.bound(e, e)) : n.K()).next((t => {
            ...
            return vt.forEach(t, (t => s.get([ t.indexId, this.uid ]).next((n => {
                e.push(function(t, e) {
                    const n = e ? new pt(e.sequenceNumber, new Et(zi(e.readTime), new _t(di(e.documentKey)), e.largestBatchId)) : pt.empty(), s = t.fields.map((([t, e]) => new yt(dt.fromServerFormat(t), e)));
     ...
     */    _n(t, e, n, s, i) {
        ...
        return function(t, e, n, s, i) {
            ...
            for (;u || c; ) {
                ...
                t ? (s(c), c = zt(o)) : e ? (i(u), u = zt(r)) : (u = zt(r), c = zt(o));
            }
        }(s, i, wr, (
        /* onAdd= */ s => {
    ...
    getMinOffset(t, e) {
        return vt.mapArray(this.Ye(e), (e => this.Xe(t, e).next((t => t || U())))).next(Pr);
    }
}
...
class Cr {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            ...
            let h = new jt(((t, e) => rt(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
    ...
    lookupMutationBatch(t, e) {
        return Nr(t).get(e).next((t => t ? (q(t.userId === this.userId), Hi(this.wt, t)) : null));
    }
    /**
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return Nr(t).J({
            ...
            e.userId === this.userId && (q(e.batchId >= n), i = Hi(this.wt, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        ...
        return kr(t).J({
            ...
            return Nr(t).get(c).next((t => {
                if (!t) throw U();
                q(t.userId === this.userId), i.push(Hi(this.wt, t));
            }));
            r.done();
        })).next((() => i));
    }
    ...
    pn(t, e) {
        ...
        return e.forEach((e => {
            s.push(Nr(t).get(e).next((t => {
                if (null === t) throw U();
                q(t.userId === this.userId), n.push(Hi(this.wt, t));
            })));
        })), vt.waitFor(s).next((() => n));
    }
    ...
    Tn(t) {
        return Or(t).get(this.userId).next((t => t || {
            userId: this.userId,
 ...
 */ class Fr {
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => $r(t).delete(e.targetId))).next((() => this.bn(t))).next((e => (q(e.targetCount > 0), 
    ...
    bn(t) {
        return Br(t).get("targetGlobalKey").next((t => (q(null !== t), t)));
    }
    Pn(t, e) {
    ...
    getMatchingKeysForTargetId(t, e) {
        ...
        return s.J({
            ...
            const s = di(t[1]), r = new _t(s);
            i = i.add(r);
        })).next((() => i));
    }
    containsKey(t, e) {
        const n = hi(e.path), s = IDBKeyRange.bound([ n ], [ ut(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return Lr(t).J({
 ...
 */ class qr {
    constructor(t) {
        this.Sn = t, this.buffer = new jt(Ur), this.Dn = 0;
    }
    Cn() {
        return ++this.Dn;
    }
    ...
    kn(t) {
        F("LruGarbageCollector", `Garbage collection scheduled in ${t}ms`), this.Nn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , t, (async () => {
            ...
            try {
                ...
                xt(t) ? F("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Pt(t);
            }
            await this.kn(3e5);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Gr {
    ...
    nthSequenceNumber(t, e) {
        if (0 === e) return vt.resolve(Bt.ot);
        const n = new qr(e);
    ...
    collect(t, e) {
        ...
        vt.resolve(vr)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (F("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        vr) : this.$n(t, e)));
    }
    getCacheSize(t) {
...
class Qr {
     ...
     */    Un(t, e) {
        return function(t, e) {
            let n = !1;
            return Or(t).Y((s => xr(t, s, e).next((t => (t && (n = !0), vt.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.Ln(t, ((r, o) => {
            if (o <= e) {
                const e = this.Un(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r, at.min()), Lr(t).delete([ 0, hi(r.path) ]))));
                }));
                s.push(e);
            }
 ...
 */ (e, n));
     ...
     */    jn(t, e) {
        let n = cs(), s = new Kt(_t.comparator);
        return this.Qn(t, e, ((t, e) => {
            const i = this.Kn(t, e);
    ...
    getMetadata(t) {
        return Yr(t).get("remoteDocumentGlobalKey").next((t => (q(!!t), t)));
    }
    qn(t, e) {
 ...
 */ class Jr extends Wr {
    ...
    applyChanges(t) {
        const e = [];
        let n = 0, s = new jt(((t, e) => rt(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            ...
            if (e.push(this.zn.removeEntry(t, i, o.readTime)), r.isValidDocument()) {
                ...
                const n = Qi(this.zn.wt, r.convertToNoDocument(at.min()));
 ...
 */ class so {
     ...
     */    getDocument(t, e) {
        let n = null;
        return this.documentOverlayCache.getOverlay(t, e).next((s => (n = s, this.getBaseDocument(t, e, n)))).next((t => (null !== n && Qn(n.mutation, t, Ht.empty(), ct.now()), 
        t)));
    }
    /**
     ...
     */    computeViews(t, e, n, s) {
        ...
        return e.forEach(((t, e) => {
            ...
            Qn(o.mutation, e, o.mutation.getFieldMask(), ct.now()));
    ...
    getDocumentsMatchingCollectionQuery(t, e, n) {
        ...
        this.documentOverlayCache.getOverlaysForCollection(t, e.path, n.largestBatchId)))).next((t => {
            ...
            return s.forEach(((s, i) => {
                const r = t.get(s);
                void 0 !== r && Qn(r.mutation, i, Ht.empty(), ct.now()), 
 ...
 */ class ro {
    constructor() {
        ...
        this.overlays = new Kt(_t.comparator), this.Xn = new Map;
    }
    getOverlay(t, e) {
    ...
    getOverlaysForCollection(t, e, n) {
        const s = fs(), i = e.length + 1, r = new _t(e.child("")), o = this.overlays.getIteratorFrom(r);
        for (;o.hasNext(); ) {
 ...
 */ class oo {
    constructor() {
        ...
        this.Zn = new jt(uo.ts), 
        // A set of outstanding references to a document sorted by target id.
        this.es = new jt(uo.ns);
    }
     ...
     * removed.
     */    us(t) {
        const e = new _t(new lt([])), n = new uo(e, t), s = new uo(e, t + 1), i = [];
    ...
    hs(t) {
        const e = new _t(new lt([])), n = new uo(e, t), s = new uo(e, t + 1);
        let i = gs();
        return this.es.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
...
class ao {
    ...
    constructor(t) {
        ...
        this.docs = new Kt(_t.comparator), 
    ...
    getAllFromCollection(t, e, n) {
        ...
        for (;r.hasNext(); ) {
            ...
            t.path.length > e.length + 1 || (At(Tt(i), n) <= 0 || (s = s.insert(i.key, i.mutableCopy())));
        }
        return vt.resolve(s);
    }
    getAllFromCollectionGroup(t, e, n, s) {
 ...
 */ class lo {
    constructor(t) {
         ...
         * IDs.
         */
        this.As = new oo, this.targetCount = 0, this.Rs = Mr.An();
    }
    forEachTarget(t, e) {
    ...
    vn(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.Rs = new Mr(e), this.highestTargetId = e), t.sequenceNumber > this.Es && (this.Es = t.sequenceNumber);
    }
    addTargetData(t, e) {
...
class fo {
     ...
     */
    constructor(t, e) {
        this.bs = {}, this.overlays = {}, this.Ps = new Bt(0), this.vs = !1, this.vs = !0, 
 ...
 */            const u = {
    ...
    Qs(t, e) {
        const n = e.store("mutations"), s = Hr(this.wt), i = new fo(wo.Ms, this.wt.ne);
        return n.K().next((t => {
            const n = new Map;
            return t.forEach((t => {
                var e;
                ...
                const r = new x(n), o = rr.se(this.wt, r), u = i.getIndexManager(r), c = Cr.se(r, this.wt, u, i.referenceDelegate);
                return new so(s, c, o, u).recalculateAndSaveOverlaysForDocumentKeys(new Fi(e, Bt.ot), t).next();
            }));
        }));
    }
}
...
class po {
    ...
    a, h = 14) {
        ...
        this.ti = t => Promise.resolve(), !po.V()) throw new j(Q.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Qr(this, s), this.ei = e + "main", this.wt = new Ki(u), 
        this.ni = new St(this.ei, this.Hs, new mo(this.wt)), this.Vs = new Fr(this.referenceDelegate, this.wt), 
     ...
     */    start() {
        ...
        return this.ii().then((() => {
            ...
            throw new j(Q.FAILED_PRECONDITION, yo);
    ...
    runTransaction(t, e, n) {
        ...
        const s = "readonly" === e ? "readonly" : "readwrite", i = 15 === (r = this.Hs) ? Mi : 14 === r ? Oi : 13 === r ? ki : 12 === r ? Ni : 11 === r ? xi : void U();
        /** Returns the object stores for the provided schema. */
        var r;
        let o;
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
                return this.ni.runTransaction(t, s, i, (s => (o = new Fi(s, this.Ps ? this.Ps.next() : Bt.ot), 
        "readwrite-primary" === e ? this.ai(o).next((t => !!t || this.hi(o))).next((e => {
            ...
            this.js.enqueueRetryable((() => this.ti(!1))), new j(Q.FAILED_PRECONDITION, Rt);
            return n(o);
    ...
    bi(t) {
        return Io(t).get("owner").next((t => {
            if (null !== t && this.mi(t.leaseTimestampMs, 5e3) && !this.pi(t.ownerId) && !this.di(t) && !(this.zs || this.allowTabSynchronization && t.allowTabSynchronization)) throw new j(Q.FAILED_PRECONDITION, yo);
        }));
    }
    /**
 ...
 */ class Ro {
     ...
     */    xi(t, e, n, s) {
        return cn(e) || s.isEqual(at.min()) ? this.Ni(t, e) : this.Di.getDocuments(t, n).next((i => {
            const r = this.ki(e, i);
            return this.Oi(e, r, n, s) ? this.Ni(t, e) : (O() <= u.DEBUG && F("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), gn(e)), 
            this.Mi(t, r, e, It(s, -1)));
        }));
    ...
    Ni(t, e) {
        return O() <= u.DEBUG && F("QueryEngine", "Using full collection scan to execute query:", gn(e)), 
        this.Di.getDocumentsMatchingQuery(t, e, Et.min());
    }
    /**
 ...
 */ function Do(t, e) {
    ...
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (t => {
        ...
        e.targetChanges.forEach(((r, u) => {
            ...
            e.targetMismatches.has(u) ? a = a.withResumeToken(Xt.EMPTY_BYTE_STRING, at.min()).withLastLimboFreeSnapshotVersion(at.min()) : r.resumeToken.approximateByteSize() > 0 && (a = a.withResumeToken(r.resumeToken, s)), 
            i = i.insert(u, a), 
 ...
 */ function Oo(t, e, n) {
    ...
    })).next((() => s.Fi.getDocumentsMatchingQuery(t, e, n ? i : at.min(), n ? r : gs()))).next((t => ($o(s, pn(e), t), 
    {
        documents: t,
        ji: r
    })))));
...
function Fo(t, e) {
    ...
    // TODO(indexing): Consider removing the default value.
        return n.persistence.runTransaction("Get new document changes", "readonly", (t => n.Ui.getAllFromCollectionGroup(t, e, It(s, -1), 
...
async function Bo(t, e, n, s) {
    ...
    const u = i.Ui.newChangeBuffer({
        ...
        return dn(un(lt.fromString(`__bundle__/docs/${t}`)));
    }(s));
...
async function Lo(t, e, n = gs()) {
    ...
    const s = await No(t, dn(Xi(e.bundledQuery))), i = G(t);
    return i.persistence.runTransaction("Save named query", "readwrite", (t => {
        const r = Os(e.readTime);
...
class Go {
     ...
     */    static Ji(t, e, n) {
        ...
        r && (i = new j(s.error.code, s.error.message))), r ? new Go(t, e, s.state, i) : ($("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Yi() {
        const t = {
...
class Qo {
     ...
     */    static Ji(t, e) {
        ...
        i && (s = new j(n.error.code, n.error.message))), i ? new Qo(t, n.state, s) : ($("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Yi() {
        const t = {
 ...
 */ class jo {
     ...
     */    static Ji(t, e) {
        ...
        return s ? new jo(t, i) : ($("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Wo {
     ...
     */    static Ji(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Wo(e.clientId, e.onlineState) : ($("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Ho {
    constructor(t, e, n, s, i) {
        ...
        this.sr = new Kt(rt), this.started = !1, 
        /**
 ...
 */ (e.newValue);
                        t !== Bt.ot && this.sequenceNumberHandler(t);
 ...
 */ class uu extends ou {
    ...
    onMessage(t) {
        ...
        const e = Ws(this.wt, t), n = function(t) {
            ...
            return e.targetIds && e.targetIds.length ? at.min() : e.readTime ? Os(e.readTime) : at.min();
        }(t);
     ...
     */    Qo(t) {
        ...
        e.database = qs(this.wt), e.addTarget = function(t, e) {
            ...
            return n = Le(s) ? {
                ...
                query: Xs(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Ns(t, e.resumeToken) : e.snapshotVersion.compareTo(at.min()) > 0 && (
     ...
     */    jo(t) {
        const e = {};
        e.database = qs(this.wt), e.removeTarget = t, this.Mo(e);
    }
}
 ...
 */ class cu extends ou {
    ...
    onMessage(t) {
        ...
        q(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Wo) {
            ...
            this.So.reset();
            const e = Js(t.writeResults, t.commitTime), n = Os(t.commitTime);
     ...
     */    Xo() {
        ...
        const t = {};
        t.database = qs(this.wt), this.Mo(t);
    }
    ...
    e, n, s, i) {
        ...
        this.fu = [], this.du = i, this.du.Br((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                Iu(this) && (F("RemoteStore", "Restarting streams for network reachability change."), 
 ...
 */
        ...
        F("RemoteStore", "Failed to raise snapshot:", e), await bu(t, e);
    }
}
 ...
 */ function Bu(t) {
    ...
    t.gu = function(t, e, n) {
        ...
        await vu(t)) : (await t.gu.stop(), t.au.length > 0 && (F("RemoteStore", `Stopping write stream with ${t.au.length} pending writes`), 
        t.au = []));
    }))), t.gu;
}
 ...
 */ function Uu(t, e) {
    if ($("AsyncQueue", `${e}: ${t}`), xt(t)) return new j(Q.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class qu {
    ...
    constructor(t) {
        ...
        this.keyedMap = hs(), this.sortedSet = new Kt(this.comparator);
    }
    /**
 ...
 */ class cc {
    ...
    s, i, r) {
        ...
        this.uc = new Map, this.cc = Mr.Rn(), this.onlineState = "Unknown" /* Unknown */ , 
 ...
 */ async function fc(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = G(t), s = ct.now(), i = e.reduce(((t, e) => t.add(e.key)), gs());
            let r, o;
 ...
 */ async function wc(t, e, n) {
    ...
    if (r) {
        ...
        let t = new Kt(_t.comparator);
        // TODO(b/217189216): This limbo document should ideally have a read time,
        // so that it is picked up by any read-time based scans. The backend,
        // however, does not send a read time for target removals.
                t = t.insert(r, ke.newNoDocument(r, at.min()));
        const n = gs().add(r), i = new Is(at.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new jt(rt), t, n);
        await dc(s, i), 
    ...
    /* keepPersistedTargetData */ !1).then((() => Tc(s, e, n))).catch(Pt);
}
 ...
 */ async function yc(t, e) {
    const n = G(t);
    Iu(n.remoteStore) || F("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
 ...
 */ function bc(t) {
    for (;t.nc.size > 0 && t.sc.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.ic.set(s, new uc(n)), t.sc = t.sc.insert(n, s), _u(t.remoteStore, new qi(dn(un(n.path)), s, 2 /* LimboResolution */ , Bt.ot));
    }
}
 ...
 */ async function Sc(t, e) {
    const n = G(t), s = await Oo(n.localStore, e.query, 
...
async function xc(t, e) {
    ...
    if ($c(n), Bc(n), !0 === e && !0 !== n.ac) {
        ...
        function(t) {
            ...
            e.ic.forEach(((t, n) => {
                wu(e.remoteStore, n);
            })), e.rc.cs(), e.ic = new Map, e.sc = new Kt(_t.comparator);
        }
        /**
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Fc(t, e, n) {
    ...
    if (s.ac) {
        for (const t of e) {
            ...
            const e = await Mo(s.localStore, t), n = await No(s.localStore, e);
 ...
 */ class Kc extends qc {
    ...
    dc(t) {
        const e = nu();
        if (!Ho.V(e)) throw new j(Q.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class Gc {
    ...
    terminate() {
        return async function(t) {
            const e = G(t);
            F("RemoteStore", "RemoteStore shutting down."), e.lu.add(5 /* Shutdown */), await du(e), 
            e.du.shutdown(), 
...
async function Xc(t, e) {
    ...
    t.setCredentialChangeListener((t => Mu(e.remoteStore, t))), t.setAppCheckTokenChangeListener(((t, n) => Mu(e.remoteStore, n))), 
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new jc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => zu(t, o))), n.fromCache && "server" === s.source ? i.reject(new j(Q.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Xu(n, r, {
            includeMetadataChanges: !0,
...
function Da(t, e, ...n) {
    if (t = I(t), ga("collection", "path", e), t instanceof ba) {
        const s = lt.fromString(e, ...n);
        return Ia(s), new Sa(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof va || t instanceof Sa)) throw new j(Q.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function Ca(t, e) {
    if (t = Ea(t, ba), ga("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new j(Q.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Va(t, 
    /* converter= */ null, 
    /**
...
function xa(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = it.I()), ga("doc", "path", e), t instanceof ba) {
        const s = lt.fromString(e, ...n);
    ...
    }
    {
        if (!(t instanceof va || t instanceof Sa)) throw new j(Q.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(lt.fromString(e, ...n));
        return pa(s), new va(t.firestore, t instanceof Sa ? t.converter : null, new _t(s));
    }
}
 ...
 * Firestore database.
 */ function Na(t, e) {
    return t = I(t), e = I(e), (t instanceof va || t instanceof Sa) && (e instanceof va || e instanceof Sa) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function ka(t, e) {
    return t = I(t), e = I(e), t instanceof Va && e instanceof Va && (t.firestore === e.firestore && wn(t._query, e._query) && t.converter === e.converter);
}
...
function Wa(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!St.V()) return Promise.resolve();
                const e = t + "main";
                await St.delete(e);
...
/** Parse document data from a set() call. */ function dh(t, e, n, s, i, r = {}) {
    ...
    const u = Rh(s, o);
    let c, a;
    if (r.merge) c = new Ht(o.fieldMask), a = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        ...
        c = new Ht(t), a = o.fieldTransforms.filter((t => c.covers(t.field)));
 ...
 */ function Ah(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return Ph("Unsupported field value:", e, t), Rh(t, e);
    if (t instanceof ih) 
...
function bh(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ct || t instanceof rh || t instanceof sh || t instanceof va || t instanceof ih);
}
 ...
 */ function vh(t, e, n) {
    ...
    // FieldPath.
    e = I(e)) instanceof eh) return e._internalPath;
 ...
 */ class $h {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new Oh(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new Fh(this._firestore, this._userDataWriter, n.key, n, new Oh(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new Fh(t._firestore, t._userDataWriter, n.doc.key, n.doc, new Oh(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new Fh(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Oh(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
...
/** Helper function to create a bound from a document or fields */ function sl(t, e, n, s) {
    if (n[0] = I(n[0]), n[0] instanceof xh) return function(t, e, n, s, i) {
        ...
        // results.
            ...
            if (se(t)) throw new j(Q.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!ln(t) && -1 !== c.indexOf("/")) throw new j(Q.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${s}() must be a plain document ID, but '${c}' contains a slash.`);
...
function il(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        ...
        if (!ln(e) && -1 !== n.indexOf("/")) throw new j(Q.INVALID_ARGUMENT, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        ...
        return Ie(t, new _t(s));
    }
    if (n instanceof va) return Ie(t, n._key);
    throw new j(Q.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Ta(n)}.`);
}
...
class cl {
    ...
    convertDocumentKey(t, e) {
        ...
        q(ai(n));
        const s = new ue(n.get(1), n.get(3)), i = new _t(n.popFirst(5));
        return s.isEqual(e) || 
 ...
 */ class ll {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = I(e)) || e instanceof eh ? Th(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Ih(this._dataReader, "WriteBatch.update", i._key, e), 
 ...
 */ function wl(t) {
    ...
    return ca(n, t._key).then((n => new Mh(e, s, t._key, n, new Oh(null !== n && n.hasLocalMutations, 
...
function Tl(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof eh ? Th(r, "updateDoc", t._key, e, n, s) : Ih(r, "updateDoc", t._key, e);
 ...
 */ function vl(t, e, n) {
    ...
    return new Mh(t, i, e._key, s, new Oh(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class Vl extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = I(e)) || e instanceof eh ? Th(this._dataReader, "Transaction.update", i._key, e, n, s) : Ih(this._dataReader, "Transaction.update", i._key, e), 
     ...
     */    get(t) {
        ...
        return super.get(t).then((t => new Mh(this._firestore, n, e._key, t._document, new Oh(
        /* hasPendingWrites= */ !1, 
 ...
 */ function Ml(t, e) {
    ...
    if (Array.isArray(n.indexes)) for (const t of n.indexes) {
        const e = Fl(t, "collectionGroup"), n = [];
        if (Array.isArray(t.fields)) for (const e of t.fields) {
            const t = Sh("setIndexConfiguration", Fl(e, "fieldPath"));
            "CONTAINS" === e.arrayConfig ? n.push(new yt(t, 2 /* CONTAINS */)) : "ASCENDING" === e.order ? n.push(new yt(t, 0 /* ASCENDING */)) : "DESCENDING" === e.order && n.push(new yt(t, 1 /* DESCENDING */));
        }
        s.push(new wt(wt.UNKNOWN_ID, e, n, pt.empty()));
    }
